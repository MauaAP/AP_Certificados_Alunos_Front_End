...
export function CorpoDownloadRelatorio({ professor }) {
    ...
    async function relatorioGeral() {
        try {
            await axios.get("https://ap-certificados-alunos-back-end.onrender.com/api/download-events", {
                headers: {
    ...
    async function relatorioProfessor(idProfessor, nomeProfessor) {
        try {
            ...
            await axios.get(`https://ap-certificados-alunos-back-end.onrender.com/api/professor-report/${idProfessor}`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`
                }
            }).then((response) => {
    ...
    async function relatorioReitoria() {
        try {
            await axios.get(`https://ap-certificados-alunos-back-end.onrender.com/api/reitoria-report`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`
                }
            }).then((response) => {
    ...
    async function relatorioProfUnico() {
        try {
            await axios.get(`https://ap-certificados-alunos-back-end.onrender.com/api/professor-report`, {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`
                }
            }).then((response) => {
    ...
    async function allUsers() {
        try {
            await axios.get("https://ap-certificados-alunos-back-end.onrender.com/api/users", {
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("token")}`
                }
            }).then((response) => {
